...
to make-couples
  ...
  let players-to-be-paired pool-of-singles
  set n-of-singles-selected-to-be-paired n-of-singles-at-the-beginning

  if (n-of-singles-selected-to-be-paired mod 2 = 1) [
    set n-of-singles-selected-to-be-paired (n-of-singles-selected-to-be-paired - 1)
    set players-to-be-paired (n-of n-of-singles-selected-to-be-paired pool-of-singles)
  ]
...
to play
  ask players [
    set payoff payoff-for action ([action] of mate)
  ]
end
...
to update-graphs
  ...
  set-current-plot "Singles before matching"
